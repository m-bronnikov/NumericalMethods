...
void print_RVector_x(const RVector<pair<double, double>>& x){
...
void print_solution(const RVector<pair<double, double>>& x, int itter){
    cout << "============================================================" << endl;
    cout << "|                      ANSWER:                             |" << endl;
    cout << "============================================================" << endl;
    cout << "Values:" << endl;
...
double mult_1xn_nx1_vecs(const RVector<double>& left, const RVector<double>& right){
    double ans = 0.0;
    if(left.size() != right.size()){
        throw "Wrong sizes of RVectors!";
    }
...
Matrix mult_nx1_1xn_vecs(const RVector<double>& left, const RVector<double>& right){
...
int QRmethod_values(const Matrix& A, RVector<pair<double, double>>& x, double alfa){
    Matrix Q, R, A_k = A;
    x.resize(A_k.get_m());
    int itter = 0;
    double check;
